...
extern Matrix4x4 getRotMat  (const Vector4 &v, const REAL a);
extern Matrix4x4 pose(const Vector4 &p, const Vector4 &look, const Vector4 &up);
extern Matrix4x4 orient(const Vector4 &look, const Vector4 &up);
